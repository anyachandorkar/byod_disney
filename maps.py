...
model_map = {
        ...
        "K-Means": [KMeans, "n_clusters",param_grid_kmeans],
        "DBSCAN": [DBSCAN, None,param_grid_dbs],
        "GMM": [GaussianMixture, "n_components",param_grid_gmm],
        "Agglomerative": [AgglomerativeClustering, "n_clusters",param_grid_agg]
    }
